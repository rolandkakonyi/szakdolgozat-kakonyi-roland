...
8);default:return a.charCodeAt(1)}}function l(a){if(32>a)return(16>a?"\\x0":"\\x")+a.toString(16);a=String.fromCharCode(a);if("\\"===a||"-"===a||"["===a||"]"===a)a="\\"+a;return a}function m(a){for(var k=a.substring(1,a.length-1).match(RegExp("\\\\u[0-9A-Fa-f]{4}|\\\\x[0-9A-Fa-f]{2}|\\\\[0-3][0-7]{0,2}|\\\\[0-7]{1,2}|\\\\[\\s\\S]|-|[^-\\\\]","g")),a=[],d=[],g="^"===k[0],f=g?1:0,o=k.length;f<o;++f){var j=k[f];switch(j){case "\\B":case "\\b":case "\\D":case "\\d":case "\\S":case "\\s":case "\\W":case "\\w":a.push(j);
continue}var j=c(j),e;f+2<o&&"-"===k[f+1]?(e=c(k[f+2]),f+=2):e=j;d.push([j,e]);65>e||122<j||(65>e||90<j||d.push([Math.max(65,j)|32,Math.min(e,90)|32]),97>e||122<j||d.push([Math.max(97,j)&-33,Math.min(e,122)&-33]))}d.sort(function(a,d){return a[0]-d[0]||d[1]-a[1]});k=[];j=[NaN,NaN];for(f=0;f<d.length;++f)o=d[f],o[0]<=j[1]+1?j[1]=Math.max(j[1],o[1]):k.push(j=o);d=["["];g&&d.push("^");d.push.apply(d,a);for(f=0;f<k.length;++f)o=k[f],d.push(l(o[0])),o[1]>o[0]&&(o[1]+1>o[0]&&d.push("-"),d.push(l(o[1])));
...
e;++s){v=a[s];if(v.global||v.multiline)throw Error(""+v);r.push("(?:"+i(v)+")")}return RegExp(r.join("|"),g?"gi":"g")}function O(a){var c=0;return function(l){for(var m=n,i=0,q=0,u=l.length;q<u;++q){var g=l.charAt(q);switch(g){case "\t":m||(m=[]);m.push(l.substring(i,q));i=a-c%a;for(c+=i;0<=i;i-=16)m.push("                ".substring(0,i));i=q+1;break;case "\n":c=0;break;default:++c}}if(!m)return l;m.push(l.substring(i));return m.join("")}}function D(a,c,l,m){c&&(a={source:c,basePos:a},l(a),m.push.apply(m,
a.decorations))}function y(a,c){var l={},m;(function(){for(var i=a.concat(c),g=[],q={},e=0,v=i.length;e<v;++e){var r=i[e],t=r[3];if(t)for(var k=t.length;0<=--k;)l[t.charAt(k)]=r;r=r[1];t=""+r;q.hasOwnProperty(t)||(g.push(r),q[t]=n)}g.push(/[\0-\uffff]/);m=I(g)})();var i=c.length,q=function(a){for(var g=a.source,s=a.basePos,e=[s,"pln"],v=0,g=g.match(m)||[],r={},t=0,k=g.length;t<k;++t){var d=g[t],p=r[d],f=void 0,o;if("string"===typeof p)o=z;else{var j=l[d.charAt(0)];if(j)f=d.match(j[1]),p=j[0];else{for(o=
0;o<i;++o)if(j=c[o],f=d.match(j[1])){p=j[0];break}f||(p="pln")}if((o=5<=p.length&&"lang-"===p.substring(0,5))&&!(f&&"string"===typeof f[1]))o=z,p="src";o||(r[d]=p)}j=v;v+=d.length;if(o){o=f[1];var A=d.indexOf(o),h=A+o.length;f[2]&&(h=d.length-f[2].length,A=h-o.length);p=p.substring(5);D(s+j,d.substring(0,A),q,e);D(s+j+A,o,K(p,o),e);D(s+j+h,d.substring(h),q,e)}else e.push(s+j,p)}a.decorations=e};return q}function w(a){var c=[],l=[];a.tripleQuotedStrings?c.push(["str",/^(?:\'\'\'(?:[^\'\\]|\\[\s\S]|\'{1,2}(?=[^\']))*(?:\'\'\'|$)|\"\"\"(?:[^\"\\]|\\[\s\S]|\"{1,2}(?=[^\"]))*(?:\"\"\"|$)|\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$))/,
n,"'\""]):a.multiLineStrings?c.push(["str",/^(?:\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$)|\`(?:[^\\\`]|\\[\s\S])*(?:\`|$))/,n,"'\"`"]):c.push(["str",/^(?:\'(?:[^\\\'\r\n]|\\.)*(?:\'|$)|\"(?:[^\\\"\r\n]|\\.)*(?:\"|$))/,n,"\"'"]);a.verbatimStrings&&l.push(["str",/^@\"(?:[^\"]|\"\")*(?:\"|$)/,n]);var m=a.hashComments;m&&(a.cStyleComments?(1<m?c.push(["com",/^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/,n,"#"]):c.push(["com",/^#(?:(?:define|elif|else|endif|error|ifdef|include|ifndef|line|pragma|undef|warning)\b|[^\r\n]*)/,
n,"#"]),l.push(["str",/^<(?:(?:(?:\.\.\/)*|\/?)(?:[\w-]+(?:\/[\w-]+)+)?[\w-]+\.h|[a-z]\w*)>/,n])):c.push(["com",/^#[^\r\n]*/,n,"#"]));a.cStyleComments&&(l.push(["com",/^\/\/[^\r\n]*/,n]),l.push(["com",/^\/\*[\s\S]*?(?:\*\/|$)/,n]));a.regexLiterals&&l.push(["lang-regex",RegExp("^"+P+"(/(?=[^/*])(?:[^/\\x5B\\x5C]|\\x5C[\\s\\S]|\\x5B(?:[^\\x5C\\x5D]|\\x5C[\\s\\S])*(?:\\x5D|$))+/)")]);a=a.keywords.replace(/^\s+|\s+$/g,"");a.length&&l.push(["kwd",RegExp("^(?:"+a.replace(/\s+/g,"|")+")\\b"),n]);c.push(["pln",
/^\s+/,n," \r\n\t\u00a0"]);l.push(["lit",/^@[a-z_$][a-z_$@0-9]*/i,n],["typ",/^@?[A-Z]+[a-z][A-Za-z_$@0-9]*/,n],["pln",/^[a-z_$][a-z_$@0-9]*/i,n],["lit",/^(?:0x[a-f0-9]+|(?:\d(?:_\d+)*\d*(?:\.\d*)?|\.\d\+)(?:e[+\-]?\d+)?)[a-z]*/i,n,"0123456789"],["pun",/^.[^\s\w\.$@\'\"\`\/\#]*/,n]);return y(c,l)}function Q(a){function c(a){if(a>s){e&&e!==v&&(g.push("</span>"),e=n);!e&&v&&(e=v,g.push('<span class="',e,'">'));var c=x(k(l.substring(s,a))).replace(j?p:d,"$1&#160;");j=o.test(c);g.push(c.replace(f,w));
s=a}}var l=a.source,m=a.extractedTags,i=a.decorations,q=a.numberLines,u=a.sourceNode,g=[],s=0,e=n,v=n,r=0,t=0,k=O(window.PR_TAB_WIDTH),d=/([\r\n ]) /g,p=/(^| ) /gm,f=/\r\n?|\n/g,o=/[ \r\n]$/,j=b,h=window._pr_isIE6(),u=h?u&&"PRE"===u.tagName?6===h?"&#160;\r\n":7===h?"&#160;<br />\r":8===h?"&#160;<br />":"&#160;\r":"&#160;<br />":"<br />",w;if(q){for(var J=[],h=0;10>h;++h)J[h]=u+'</li><li class="L'+h+'">';var y="number"===typeof q?q-1:0;g.push('<ol class="linenums"><li class="L',y%10,'"');y&&g.push(' value="',
y+1,'"');g.push(">");w=function(){var a=J[++y%10];return e?"</span>"+a+'<span class="'+e+'">':a}}else w=u;for(;;)if(u=r<m.length?t<i.length?m[r]<=i[t]:b:z)c(m[r]),e&&(g.push("</span>"),e=n),g.push(m[r+1]),r+=2;else if(t<i.length)c(i[t]),v=i[t+1],t+=2;else break;c(l.length);e&&g.push("</span>");q&&g.push("</li></ol>");a.prettyPrintedHtml=g.join("")}function h(a,c){for(var l=c.length;0<=--l;){var m=c[l];B.hasOwnProperty(m)?"console"in window&&console.warn("cannot override language handler %s",m):B[m]=
...
' $1="$2$3$4"').match(/[cC][lL][aA][sS][sS]=\"[^\"]*\bnocode\b/)){var v=e.match(M)[2],r=1,t;t=g+1;a:for(;t<s;++t){var k=i[t].match(M);if(k&&k[2]===v)if("/"===k[1]){if(0===--r)break a}else++r}t<s?(h.push(q,i.slice(g,t+1).join("")),g=t):h.push(q,e)}else h.push(q,e)}else{var d;var r=e,p=r.indexOf("&");if(0>p)d=r;else{for(--p;0<=(p=r.indexOf("&#",p+1));){var f=r.indexOf(";",p);if(0<=f){var o=r.substring(p+3,f),j=10;o&&"x"===o.charAt(0)&&(o=o.substring(1),j=16);var w=parseInt(o,j);isNaN(w)||(r=r.substring(0,
...
g.now()+250:Infinity;s<m.length&&g.now()<l;s++){var i=m[s];if(i.className&&0<=i.className.indexOf("prettyprint")){var h=i.className.match(/\blang-(\w+)\b/);h&&(h=h[1]);for(var k=z,d=i.parentNode;d;d=d.parentNode)if(("pre"===d.tagName||"code"===d.tagName||"xmp"===d.tagName)&&d.className&&0<=d.className.indexOf("prettyprint")){k=b;break}if(!k){d=i;n===E&&(k=document.createElement("PRE"),k.appendChild(document.createTextNode('<!DOCTYPE foo PUBLIC "foo bar">\n<foo />')),E=!/</.test(k.innerHTML));if(E)if(k=
d.innerHTML,"XMP"===d.tagName)k=x(k);else{if("PRE"===d.tagName)d=b;else if(ca.test(k)){var p="";if(d.currentStyle)p=d.currentStyle.whiteSpace;else if(window.getComputedStyle)p=window.getComputedStyle(d,n).whiteSpace;d=!p||"pre"===p}else d=b;d||(k=k.replace(/(<br\s*\/?>)[\r\n]+/g,"$1").replace(/(?:[\r\n]+[ \t]*)+/g," "))}else{k=[];for(d=d.firstChild;d;d=d.nextSibling)C(d,k);k=k.join("")}k=k.replace(/(?:\r\n?|\n)$/,"");d=i.className.match(/\blinenums\b(?::(\d+))?/);e={sourceCodeHtml:k,langExtension:h,
sourceNode:i,numberLines:d?d[1]&&d[1].length?+d[1]:b:z};L(e);if(i=e.prettyPrintedHtml)if(h=e.sourceNode,"XMP"===h.tagName){k=document.createElement("PRE");for(d=0;d<h.attributes.length;++d)if(p=h.attributes[d],p.specified){var f=p.name.toLowerCase();"class"===f?k.className=p.value:k.setAttribute(p.name,p.value)}k.innerHTML=i;h.parentNode.replaceChild(k,h)}else h.innerHTML=i}}}s<m.length?setTimeout(c,250):a&&a()}for(var l=[document.getElementsByTagName("pre"),document.getElementsByTagName("code"),
document.getElementsByTagName("xmp")],m=[],i=0;i<l.length;++i)for(var h=0,u=l[i].length;h<u;++h)m.push(l[i][h]);var l=n,g=Date;g.now||(g={now:function(){return(new Date).getTime()}});var s=0,e;c()}var P=function(){for(var a="! != !== # % %= & && &&= &= ( * *= += , -= -> / /= : :: ; < << <<= <= = == === > >= >> >>= >>> >>>= ? @ [ ^ ^= ^^ ^^= { | |= || ||= ~ break case continue delete do else finally instanceof return throw try typeof".split(" "),c="(?:^^|[+-]",h=0;h<a.length;++h)c+="|"+a[h].replace(/([^=<>:&a-z])/g,
"\\$1");return c+=")\\s*"}(),F=/&/g,G=/</g,H=/>/g,N=/\"/g,V=/&lt;/g,W=/&gt;/g,X=/&apos;/g,Y=/&quot;/g,$=/&amp;/g,Z=/&nbsp;/g,ca=/[\r\n]/g,E=n,R=RegExp("[^<]+|<\!--[\\s\\S]*?--\>|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>|</?[a-zA-Z](?:[^>\"']|'[^']*'|\"[^\"]*\")*>|<","g"),S=/^<\!--/,T=/^<!\[CDATA\[/,U=/^<br\b/i,M=/^<(\/?)([a-zA-Z][a-zA-Z0-9]*)/,da=w({keywords:"break continue do else for if return while auto case char const default double enum extern float goto int long register short signed sizeof static struct switch typedef union unsigned void volatile catch class delete false import new operator private protected public this throw true try typeof alignof align_union asm axiom bool concept concept_map const_cast constexpr decltype dynamic_cast explicit export friend inline late_check mutable namespace nullptr reinterpret_cast static_assert static_cast template typeid typename using virtual wchar_t where break continue do else for if return while auto case char const default double enum extern float goto int long register short signed sizeof static struct switch typedef union unsigned void volatile catch class delete false import new operator private protected public this throw true try typeof abstract boolean byte extends final finally implements import instanceof null native package strictfp super synchronized throws transient as base by checked decimal delegate descending dynamic event fixed foreach from group implicit in interface internal into is lock object out override orderby params partial readonly ref sbyte sealed stackalloc string select uint ulong unchecked unsafe ushort var break continue do else for if return while auto case char const default double enum extern float goto int long register short signed sizeof static struct switch typedef union unsigned void volatile catch class delete false import new operator private protected public this throw true try typeof debugger eval export function get null set undefined var with Infinity NaN caller delete die do dump elsif eval exit foreach for goto if import last local my next no our print package redo require sub undef unless until use wantarray while BEGIN END break continue do else for if return while and as assert class def del elif except exec finally from global import in is lambda nonlocal not or pass print raise try with yield False True None break continue do else for if return while alias and begin case class def defined elsif end ensure false in module next nil not or redo rescue retry self super then true undef unless until when yield BEGIN END break continue do else for if return while case done elif esac eval fi function in local set then until ",
